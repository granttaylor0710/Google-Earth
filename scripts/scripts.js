   ...
   var X,
        ...
        pt,
        dt,
		person_data = new Array(),
		person_types = new Array(),
		person_interval,
        ht;

function addPlace_JS(lat, lng, type) {
	var ttt = [];
	ttt[0] = lng;
	ttt[1] = lat;
	var coords = [];
	...
	person_data.push(coords);
	person_types.push(type);

	Y.launch(C, type, coords, null);
}
...
function main() {
    ...
    function u(e) {
        if (Q.countries.length) {
			if (C.draw_world &&  person_data.length > 0 && person_interval < C.time)
			{
				for (var ii = 0; ii < person_data.length; ii ++)
				{
					Y.launch(C, person_types[ii], person_data[ii], null);
				}
				person_interval = C.time + 2;
			}
...
! function() {
    ...
    t.prototype.compute_target_rank = function() {
        ...
        1: new t(1, "GD", "Oral & Maxiofacial Surgery", "ff0d02" /*Color*/ , 5),
        2: new t(2, "OMP", "General Dentistry", "04fe04", 4),
        3: new t(3, "PDS", "Periodontics", "6f2aab", 3),
        4: new t(4, "ODS", "Orthodontics", "ffffff" /*Dark Color,Light Color*/ , 32),
        5: new t(5, "OMB", "Oral Microbiology", "923975", 6),
        6: new t(6, "OM", "Oral Medicine", "eb009b", 8),
        7: new t(7, "GPH", "Pediatric Dentistry", "f67f01", 7),
        8: new t(8, "OMS", "Prosthodontics", "fffc0d", 13),
        9: new t(9, "EDS", "Endodontics", "c8a317", 14),
        10: new t(10, "PRDS", "Oral & Maxiofacial Pathology", "ff8bfe", 15),
        11: new t(11, "PD", "General Public Health", "73ff84", 9),
        12: new t(12, "DMR", "Dental & Maxiofacial Radiology", "3044b5", 10),
        13: new t(13, "RD", "Restorative Dentistry", "01c4b4", 11),
        14: new t(14, "SCD", "Special Care Dentistry", "61afdf", 12)
    };
    var f = 1e3,
        p = 100,
        d = 8 * p;
